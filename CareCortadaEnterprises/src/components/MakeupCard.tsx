...
const MakeupCard = (props: MakeupCardProps) => {
  ...
  return (
    <div className='bg-complement2 p-5 rounded-xl shadow-sm'>
        <Link to={slug}>
            <img src={image} alt={name} className='w-full h-80 object-cover objetct-top 
            drop-shadow-[0_80px_30px_#0007] rounded mb-4' />
        </Link>
